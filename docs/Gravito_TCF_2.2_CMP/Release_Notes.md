...
## Release Notes for TCF CMP Version 5.0.1
...
-   Added support for GCMV2: Gravito TCF CMP now includes support for GCMV2. [Read more](https://www.gravito.net/blog/google-consent-mode-tcf/)
